...
This repository is therefore an isolated development package, but it is not
yet installable through the Inox CLI. External package discovery and a stable
public compiler/runtime extension API still need to be added to Inox.
